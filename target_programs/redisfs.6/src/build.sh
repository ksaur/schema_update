#!/bin/bash
~/kitsune-core/bin/bin/ktcc --doglobalreg --dostackvars  --keepunused -ggdb3 -Wall -lz -ldl -fPIC -I~/kitsune-core/bin/bin/ -c redisfs.c -D_FILE_OFFSET_BITS=64 -zdefs -ldl -lrt -lfuse  -lz -I. -DVERSION=0.5 
